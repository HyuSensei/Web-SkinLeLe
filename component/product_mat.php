...
$sql_so_san_pham="select count(*) from san_pham where danh_muc=N'Mắt'";
...
if (isset($_POST['start']) && isset($_POST['end'])) {
    $start = $_POST['start'];
    $end = $_POST['end'];
    $sql = "select * from san_pham where danh_muc=N'Mắt' and gia >=$start and gia<=$end ";
} else {
    $sql = "select * from san_pham where danh_muc=N'Mắt' limit $so_san_pham_mot_trang offset $bo_qua";
    // $result = mysqli_query($connect, $sql);
}
$result = mysqli_query($connect, $sql);
?>
