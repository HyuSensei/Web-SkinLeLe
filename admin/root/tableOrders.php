                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <a href="../component/crud/crud_order/create_order.php" style="float: right;" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add New Order</a>
                                ...
                                if ($result = mysqli_query($link, $sql)) {
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        while ($row = mysqli_fetch_array($result)) {
                                            ...
                                            echo "<td>";
                                            echo '<a href="../component/crud/crud_order/update_order.php?id=' . $row['id'] . '" class="mr-3" title="Update Record" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
                                            echo '<a href="../component/crud/crud_order/delete_order.php?id=' . $row['id'] . '" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                                            echo "</td>";
                                            echo "</tr>";
                                        }
                                        echo "</tbody>";
