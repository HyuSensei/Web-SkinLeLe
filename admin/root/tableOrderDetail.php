                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <a href="../component/crud/crud_order_detail/create_order_detail.php" style="float: right;" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add New Order Detail</a>
