        ...
        <div class="row">
                    ...
                    <div>
                        ...
                        <li><a style="font-weight: bold;" href="product_1.php">Chăm Sóc Da</a>
                                <ul style="margin-top: 15px;">
                                    <li style="margin-top: 15px;"><a style="font-weight: bold;" href="productt_giaiphaplanda.php">Giải Pháp Làn Da</a></li>
            ...
            <img src="./images/bannerdanhmuc.webp" alt="" width="100%">
                <div class="product-area section" style="margin-top: -70px;">
                    <div class="container">
                        <p style="font-size: 25px;font-weight: bold;font-family: 'Times New Roman', Times, serif;color: #c05353;margin-bottom: 20px;">GIẢI PHÁP LÀN DA</p>
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade show active" id="man" role="tabpanel">
                                            <div class="tab-single">
                                                <div class="row">
                                                    <?php include('./component/product_giaiphaplanda.php') ?>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
